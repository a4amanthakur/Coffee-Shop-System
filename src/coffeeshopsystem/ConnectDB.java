    ...
    public Connection connect()
    {
        if(con==null)
        {
            ...
            //for remote phpmyadmin
                ...
                Class.forName("com.mysql.cj.jdbc.Driver");
                con=  DriverManager.getConnection("jdbc:mysql://amans-webserver.cel7s2vhdev5.ap-south-1.rds.amazonaws.com:3306/CoffeeManagementSystem","amanthakuronly4u","$$Aman928");
             }
