...
/*
        btnAddItem.setBackground(new java.awt.Color(1, 39, 40));
        btnAddItem.setFont(new java.awt.Font("Ubuntu", 1, 16)); // NOI18N
        btnAddItem.setForeground(new java.awt.Color(247, 237, 237));
        ...
        btnAddItem.setPreferredSize(new Dimension(300,50));;
*/
